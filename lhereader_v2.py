...
# https://github.com/AndreasAlbert/lhereader/blob/master/lhereader/__init__.py#L123
...
class LHEReader():
    ...
    def unpack_from_iterator(self):
        ...
        event.num_part = num_part
        event.weights = float(event_header.split()[2].strip())
        # print(float(event_header.split()[2].strip()))
